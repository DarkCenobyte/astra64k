...
void mainCRTStartup(void){
    ...
    if(!initRender())failStartup("Astra needs OpenGL 3.0 compatibility support.",2);
    ...
    if(test){frame(70.25f);glFinish();writeImage("Astra-v" ASTRA_VERSION "-Windows-selftest.ppm");writeWave("Astra-v" ASTRA_VERSION "-Windows-selftest.wav");ExitProcess(0);}
